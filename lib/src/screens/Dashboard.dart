...
import 'package:flutter_train/src/shared/styles.dart';
...
class Dashboard extends StatefulWidget {
  ...
  Dashboard(this.userName,{Key key, this.pageTitle}) : super(key: key);
  @override
...
Widget storeTab(BuildContext context,String user) {

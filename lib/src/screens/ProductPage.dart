                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Container(
                              width: 180,
                             child: OutlineButton(
                                 onPressed :() => Navigator.push((context),MaterialPageRoute(builder: (BuildContext context) => OrderPage(widget.productData.name,widget.productData.price,_quantity,widget.productData.userName))),
                               // child: Text(text),
                             ...
                             /* child: OutlineButton(
                                onPressed: () => Navigator.push((context),MaterialPageRoute(builder: (BuildContext context) => OrderPage())),
                                color: Colors.white,
                                shape: new RoundedRectangleBorder(
                                  borderRadius: new BorderRadius.circular(7.0),
                                ),

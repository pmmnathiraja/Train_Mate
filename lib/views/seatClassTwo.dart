...
import 'package:flutter_train/views/SeatconformTwo.dart';
import 'package:flutter_train/views/routeDisplay.dart';
import 'package:flutter_train/views/trainClassSelect.dart';
import 'package:line_icons/line_icons.dart';

class TrainPageTwo extends StatefulWidget {
  TrainPageTwo (this._Start,this._Destination,this._Day,this._Train_ID,this._userEmail,this._startTime,this._destinationTime) : super();
  String _Start, _Destination,_Day,_Train_ID,_userEmail,_startTime,_destinationTime;
  @override
  _TrainPageTwoState createState() => _TrainPageTwoState();
}

class _TrainPageTwoState extends State<TrainPageTwo> {
  ...
  Widget build(BuildContext context) {
    ...
    final submitBtn = Container(
      ...
      child: RaisedButton(
        ...
        onPressed: () async => await(Navigator.push((context),MaterialPageRoute(builder: (BuildContext context) => SeatConformPageTwo
  ...
  SeatCheck() async{
    for(int x = _StartLocation;x <= _DestinationLocation;x++){
      Firestore.instance.collection('${widget._Train_ID}').document('${x}_ClassTwo').snapshots().listen(SeatChecker);
      // print(x);
    }
  }

...
class SeatConformPageOne extends StatefulWidget{
  ...
  final int totalAmount ;
      SeatConformPageOne(this._train_ID,this._user_Email,this.DistanceBook,
  ...
  @override
  _SeatConformPageOneState createState() => _SeatConformPageOneState();
}
class _SeatConformPageOneState extends State<SeatConformPageOne> {
 /* SnackBar get snackBar => SnackBar(
  ...
  Future<void> SeatChecker() async {
    ...
    Future<void> SaveUserInfo() async{
      Firestore.instance.collection('${widget._user_Email}').document('BookSeatClassOne').setData({ 'Seat1': 'no','Seat2': 'no','Seat3': 'no','Seat4': 'no','Seat5': 'no','Seat6': 'no','Seat7': 'no','Seat8': 'no','Seat9': 'no','Seat10': 'no',
      ...
      for (int i = 1; i < 25; i++) {
        if (widget.DistanceBook[i] == 2) {
          Firestore.instance.collection('${widget._user_Email}').document('BookSeatClassOne').setData({'Seat$i': 'book'}, merge: true);
          }
        }
      print('33333333333333333333333333333333333333333333333333333333333333333333333333${widget._user_Email}');
